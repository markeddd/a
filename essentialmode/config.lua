...
ip = GetConvar('es_couchdb_url', 'kupa') 	        -- Change to wherever your DB is hosted, use convar
port = GetConvar('es_couchdb_port', '5984') 	        -- Change to whatever port you have CouchDB running on, use convar
auth = GetConvar('es_couchdb_password', 'Marked:Kurwamac321.') 	-- "user:password", if you have auth setup, use convar
